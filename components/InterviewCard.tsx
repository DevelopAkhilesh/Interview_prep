        ...
        <div>
            ...
            <div className='flex flex-col mt-3'>
                <div className='flex flex-row gap-5'>
                    <Image src="/calendar.svg" alt='calander' width={20} height={20}/>
                    <p>{formattedDate}</p>
                ...
                <p className='line-clamp-2 mt-5'>
                    {feedback?.finalAssessment||"You Haven't taken the inteview yet. Take it now to improve your skills."}
                </p>
            </div>
            <div className='flex flex-row justify-between mt-3'>
                ...
                <Button className='btn-primary'>
                    ...
                    {feedback?"CheckFeedback":"View Interview"}</Link>
                </Button>
            </div>
        </div>
